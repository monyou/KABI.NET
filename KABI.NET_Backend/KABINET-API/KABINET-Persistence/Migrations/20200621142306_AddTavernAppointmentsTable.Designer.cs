...
namespace KABINET_Persistence.Migrations
{
    ...
    [Migration("20200621142306_AddTavernAppointmentsTable")]
    partial class AddTavernAppointmentsTable
    {
            ...
            modelBuilder.Entity("KABINET_Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8edb41e8-3617-4155-be15-c1a2784a1e45"),
                            Email = "admin@kabi.net",
                            FirstName = "Admin",
                            LastName = "Admin",
                            Password = "$MYHASH$V1$10000$nwo+pSwcbGNR13fd+9CXE8CTO3uo08J+LBiyNW+5Xb/PUjQi",
                            Role = 1,
                            Room = "999"
                        });
                });
